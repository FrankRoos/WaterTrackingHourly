...
package org.gft.processor.watertrackinghourly;
...
public class WaterTrackingHourly extends StreamPipesDataProcessor {
    ...
    public void onEvent(Event event,SpOutputCollector out){
       ...
       event.addField("waitingtimeConsumption", waitingtime_consumption);
       event.addField("hourlyConsumption", hourly_consumption);
